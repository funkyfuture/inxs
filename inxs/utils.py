...
def reduce_whitespaces(text: str, translate_to_space: str = WHITESPACES_WO_SPACE,
                       strip: str = 'lr') -> str:
    """ Reduces the whitespaces of the provided string by replacing any of the defined whitespaces
        with a simple space (U+20) and stripping consecutive ones to a a single one.

        :param text: The input string.
        :param translate_to_space: The characters that should are defined as whitespace.
                                   Defaults to all common whitespace characters from the ASCII set.
        :param strip: The 'sides' of the string to strip from any whitespace at all, indicated by
                      'l' for the beginning and/or 'r' fo the and og the string.
