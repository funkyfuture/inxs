...
from inxs import (
    TRAVERSE_DEPTH_FIRST, TRAVERSE_BOTTOM_TO_TOP, TRAVERSE_LEFT_TO_RIGHT, lib, utils, Not, Rule,
...
"""
Normalizes any whitespace character of element's text and tail to a simple space and reduces
consecutives to one.
"""
